...
public class ReviewAcceptanceTest extends AcceptanceTest {
    ...
    private static void 수정된_리뷰_검증(final ReviewResponse 수정된_리뷰_응답, final List<Long> 수정_입력_태그) {
        assertAll(
    ...
    private static void 조회된_리뷰_검증(final ReviewResponse 조회된_리뷰, final List<Long> 입력_태그) {
        assertAll(
    ...
    private static void 생성된_리뷰_검증(final ReviewResponse 생성된_리뷰_응답, final List<Long> 입력_태그) {
        assertAll(
